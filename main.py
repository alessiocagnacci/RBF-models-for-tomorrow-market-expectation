...
#  KERNEL RBF 
# C(): Volatility variations, for ALL is chosen as the better value
# RBF(): Flexibility
...
# TRAINING
print("Training absolut volatility model...")
...
print(f"TESTING RESULTS for Absolute Volatility")
...
# How many times was the direction correct
...
print("Training expected regime of volatility...")
...
print("TESTING RESULTS for regime of volatility")
...
print("TESTING RESULT for expected trend")
print("Classification Report:")
